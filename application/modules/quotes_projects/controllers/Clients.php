...
class Clients extends Admin_Controller
{
    ...
    {
        // Display active clients by defaults
    ...
    public function form($id = null)
    {
        ...
        if ($this->mdl_clients->run_validation()) {
            ...
            if ($result !== true) {
                ...
                redirect('quotes_projects/form/' . $id);
                return;
            } else {
                redirect('quotes_projects/view/' . $id);
            }
        }
    ...
    public function view($client_id)
    {
        ...
        $this->layout->buffer(
            array(
                ...
                array(
                    'partial_notes',
                    'quotes_projects/partial_notes'
                ),
                array(
                    'content',
                    'quotes_projects/view'
                )
            )
        );
