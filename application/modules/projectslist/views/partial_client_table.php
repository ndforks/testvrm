    ...
    <table class="table table-hover table-striped">
        ...
        <?php foreach ($records as $client) : ?>
            <tr>
                ...
                <td><?php echo anchor('projectslist/view/' . $client->client_id, htmlsc(format_client($client))); ?></td>
                ...
                <td>
                    <div class="options btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('projectslist/view/' . $client->client_id); ?>">
                                    <i class="fa fa-eye fa-margin"></i> <?php _trans('view'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('projectslist/form/' . $client->client_id); ?>">
                            ...
                            <li>
                                <form action="<?php echo site_url('projectslist/delete/' . $client->client_id); ?>"
                                      method="POST">
                                    <?php _csrf_field(); ?>
