            ...
            $.post("<?php echo site_url('quotes/ajax/save'); ?>", {
                ...
                function (data) {
                    ...
                    if (response.success === 1) {
                        window.location = "<?php echo site_url('projquotes/view'); ?>/" + <?php echo $quote_id; ?>;
                    } else {
...
<div id="content">
    ...
    <div id="quote_form">
        ...
        <?php if (get_setting('show_responsive_itemlist') == 1) {
             $this->layout->load_view('projquotes/partial_itemlist_responsive');
           } else {
             $this->layout->load_view('projquotes/partial_itemlist_table');
           }
         ?>
